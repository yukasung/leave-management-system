...
import { sendMail, buildLeaveApprovedEmail, buildLeaveCancelApprovedEmail, buildLeaveRejectedEmail } from '@/lib/mailer'
  ...
  try {
    ...
    void (async () => {
      try {
        ...
        console.error('[hrRejectLeaveRequest] email failed:', err)
      }
    })()
